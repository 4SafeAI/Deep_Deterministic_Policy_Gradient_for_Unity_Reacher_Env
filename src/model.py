...
def save_model(model, filename='model.pt'):
    ...
    """
    checkpoint = {
        'input_size': model.linear_layers[0].in_features,
        'output_size': model.linear_layers[-1].out_features,
        'hidden_layers': [layer.out_features for layer in model.linear_layers[:-1]],
